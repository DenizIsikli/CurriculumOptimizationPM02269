...
from src.config import XES_OUTPUT_PATH, SAMPLED_DATA_PATH
MODEL_PATH = os.path.join("results", "process_discovery")
...
def visualize_petri_net_no_graphviz(miner_name):
    ...
    nx.draw_networkx_nodes(G, pos, nodelist=place_nodes, node_size=900)
    nx.draw_networkx_nodes(G, pos, nodelist=trans_nodes, node_size=900)
...
# ===============================================================
# PERFORMANCE VISUALIZATIONS (SAMPLED CSV)
# ===============================================================
def visualize_throughput_times():
    ...
    plt.figure()
    plt.hist(durations_days, bins=30)
...
def generate_all_visuals():
    ...
    print("\n=== PERFORMANCE VISUALS (FROM SAMPLED LOG) ===")
